<?php /* Smarty version 2.6.18, created on 2016-02-11 16:10:13
         compiled from article.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'article.html', 75, false),)), $this); ?>
<!DOCTYPE HTML>
<html>
<head>
 ...
 ?>
	<div class="ad_title_box">
		<div class="ad_title">
			...
			<div class="ad_title_li">
				<ul>
					<?php if ($this->_tpl_vars['news']['type'] == 2): ?>
	...
	<div id="warp">
		...
		<div class="left_content">
			<p style=" margin:0px 0px 60px 20px;text-indent:0em;"><a href="index.php">首页</a><span style=" color:#2298d8; font-size:16px;">&nbsp;>>&nbsp;<?php if ($this->_tpl_vars['news']['type'] == 1): ?><a href="news.php">留学资讯</a><?php elseif ($this->_tpl_vars['news']['type'] == 2): ?><a href="trend.php">TOP动态</a><?php endif; ?>&nbsp;>>&nbsp;<?php echo $this->_tpl_vars['news']['name']; ?>
</span></p>
			<h3 style="text-align:center;"> <?php echo $this->_tpl_vars['news']['name']; ?>
</h3>
			<p style=" text-indent:0em; text-align:center; color:#888888; font-size:9px;">发布时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['news']['addtime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %H:%M:%S") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %H:%M:%S")); ?>
</p>
			<br />
